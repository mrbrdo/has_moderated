...
If a migration file is created, look if it matches your current schema. If it doesn't update the schema manually so it will match the one in the migration.
